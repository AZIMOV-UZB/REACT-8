...
const Json = () => {
  ...
  const categoreyItems = category?.map((categorys) => (
    <li
      ...
      className="border  py-1 px-2 rounded-full bg-amber-300	 mb-5  dark:text-white dark:bg-lime-700 "
  ...
  return (
    <div className="container mx-auto mb-16 px-4">
      ...
      >
        <li
          data-value={``}
          className=" border py-1 px-2 rounded-full bg-amber-300	 mb-5  dark:text-white dark:bg-lime-700 collection"
          onClick={(e) => setSelectCategory(e.target.dataset.value)}
        >
          All
        </li>
